...
import by.javacource.task1.entity.*;
...
import static by.javacource.task1.builder.CardXmlTag.*;
...
public class CardStaxBuilder extends AbstractCardBuilder{
    ...
    private AbstractPostalCard buildPostalCard(XMLStreamReader reader) throws XMLStreamException, CardException {
        AbstractPostalCard postalCard = reader.getLocalName().
                equals(GREETING_CARD.getTagName()) ? new GreetingCard() : new PromotionalCard();
